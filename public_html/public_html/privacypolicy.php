<?php include 'phpcomponents/head.php'?>
 ...
 <body>
  ...
  <!-- Page Content -->
  <div class="container">
   <h1>Privacy Policy for Onkorisk</h1>

   <p>
    At Onkorisk, accessible from onkorisk.iqhs.pl, one of our main priorities is
    the privacy of our visitors. This Privacy Policy document contains types of
    information that is collected and recorded by Onkorisk and how we use it.
   </p>
   ...
   <p>
    ...
    and/or collect in Onkorisk. This policy is not applicable to any information
   ...
   <p>
    Onkorisk follows a standard procedure of using log files. These files log
   ...
   <p>
    Like any other website, Onkorisk uses 'cookies'. These cookies are used to
   ...
   <p>
    ...
    advertising partners of Onkorisk.
   </p>

   <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on Onkorisk, which are sent directly to users'
   ...
   <p>
    Note that Onkorisk has no access to or control over these cookies that are
   ...
   <p>
    Onkorisk's Privacy Policy does not apply to other advertisers or websites.
   ...
   <p>
    Onkorisk does not knowingly collect any Personal Identifiable Information
